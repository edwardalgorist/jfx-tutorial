 ...
 */
public class PopoverEventHandling extends Application {
    ...
    private void buildUI() {
        ...
        popover.setOnShowing(event -> System.out.println("Popover is showing!"));
        popover.setOnHiding(event -> System.out.println("Popover is hiding!"));
        popover.setOnHidden(event -> System.out.println("Popover is hidden!"));
