 ...
 */
public class RangeSliderListeners extends Application {
    ...
    private void buildUI() {
        ...
        // Attach a ChangeListener to the low value property
        // For this example, we print the new low value to the console
        rangeSlider.lowValueProperty().addListener((observable, oldValue, newValue)
                -> System.out.println("Low value changed: " + newValue));

        // Attach a ChangeListener to the high value property
        // For this example, we print the new high value to the console
        rangeSlider.highValueProperty().addListener((observable, oldValue, newValue)
                -> System.out.println("High value changed: " + newValue));
