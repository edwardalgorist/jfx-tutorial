 ...
 */
public class HandlingToolBarButtonAction extends Application {
    ...
    class AppMenu extends MenuBar {
        ...
        public AppMenu() {
            ...
            mnuNew.setOnAction(HandlingToolBarButtonAction.this::onNew);

            MenuItem mnuOpen = new MenuItem("Open");

            // Add event handler to the open menu item
            mnuOpen.setOnAction(HandlingToolBarButtonAction.this::onOpen);
            ...
            mnuSave.setOnAction(HandlingToolBarButtonAction.this::onSave);

            MenuItem mnuSaveAll = new MenuItem("Save All");

            // Add event handler to the save all menu item
            mnuSaveAll.setOnAction(HandlingToolBarButtonAction.this::onSaveAll);
