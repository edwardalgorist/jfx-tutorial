 ...
 */
public class ToolBarButtonIcons extends Application {
    ...
    class AppMenu extends MenuBar {
        ...
        public AppMenu() {
            ...
            mnuNew.setOnAction(ToolBarButtonIcons.this::onNew);

            MenuItem mnuOpen = new MenuItem("Open");

            // Add event handler to the open menu item
            mnuOpen.setOnAction(ToolBarButtonIcons.this::onOpen);
            ...
            mnuSave.setOnAction(ToolBarButtonIcons.this::onSave);

            MenuItem mnuSaveAll = new MenuItem("Save All");

            // Add event handler to the save all menu item
            mnuSaveAll.setOnAction(ToolBarButtonIcons.this::onSaveAll);
